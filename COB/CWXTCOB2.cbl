      ...
      *  TRAINING SESSIONS
      *
      *  Démonstration d'une difference
      *                                                                *
      *  INPUT FILE  - EMPLOYEE WAGE INFORMATION                       *
      *              - STORED IN XPEDITER/TSO SAMPLIB (
      *            CWXDATA)       *
      ...
      ******************************************************************
       ...
       01  SWITCHES.
           ...
           05  END-OF-MONTH-SW        PIC X        VALUE '?'.
...
*********
       ...
       01  CWXTDATE   PIC X(8)    VALUE 'CWXTDAT2'.
       01  CWXTSUBC   PIC X(8)    Value 'CWXTSUB2'.
*********
...
*********
      ...
      *        move WA-EMP-HIRE-DATE to WA-EMP-HIRE-DATE.
              IF END-OF-MONTH
...
*********
       6200-PRINT-EMPLOYEE-HEADERS. *> bonjour
